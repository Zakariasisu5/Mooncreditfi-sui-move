          ...
          <Card className="card-glow">
            <CardContent className="p-6 sm:p-8 space-y-8">
              ...
              <section>
                ...
                <p className="text-muted-foreground">
                  Our platform may integrate with third-party services such as Sui wallet providers
                  and blockchain networks. These services have their own privacy policies, 
