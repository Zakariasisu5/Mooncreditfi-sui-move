...
const Landing = () => {
  ...
  const platformStats = [
    ...
    { label: 'DeFi Lending Pools', status: 'Move Contracts Ready', icon: Coins },
  ...
  const whyCreditcoinPoints = [
    { icon: Shield, title: 'On-chain Credit History', description: 'Sui blockchain records credit history with immutable, verifiable records using Move smart contracts.' },
    { icon: TrendingUp, title: 'Reputation-Powered DeFi', description: 'MoonCreditFi uses Sui\'s object model to power lending — your repayment history IS your collateral.' },
    ...
    { icon: Globe, title: 'Financial Inclusion Mission', description: 'Leveraging Sui\'s speed and low costs to bring financial inclusion to the underbanked globally.' }
  ];
  ...
  const securityFeatures = [
    { icon: Github, title: 'Open-source Move Contracts', description: 'All Move contract code is publicly auditable on GitHub' },
    { icon: Lock, title: 'On-chain Credit Records', description: 'Credit history stored immutably on Sui blockchain' },
    { icon: FileText, title: 'No Hidden Scoring Logic', description: 'Transparent algorithms determine credit scores' },
    { icon: CheckCircle, title: 'Auditable Transactions', description: 'Every transaction is verifiable on Sui Explorer' }
  ];

  const roadmapPhases = [
    { phase: 1, title: 'Credit Profiles & Lending', status: 'Done', description: 'Move smart contracts for credit scoring and lending pools' },
    { phase: 2, title: 'DePIN Funding Module', status: 'Done', description: 'Infrastructure funding with real-yield returns' },
    { phase: 3, title: 'Full Sui Testnet Deployment', status: 'Done', description: 'Complete integration with Sui testnet' },
    { phase: 4, title: 'Mainnet + Partnerships', status: 'Next', description: 'Production launch on Sui mainnet and strategic partnerships' }
  ];
      ...
      <section className="py-12 sm:py-20 px-4 sm:px-6 lg:px-8 bg-muted/30">
        <div className="container mx-auto">
          ...
          >
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-3 sm:mb-4">
              Why <span className="mooncreditfi-glow">Sui?</span>
            </h2>
            <p className="text-sm sm:text-base text-muted-foreground max-w-2xl mx-auto">
              Sui is purpose-built for high-performance DeFi — MoonCreditFi leverages Sui's object model for credit lending and real-world infrastructure funding.
            </p>
          </motion.div>
            ...
            <Card className="card-glow max-w-3xl mx-auto bg-primary/5 border-primary/20">
              <CardContent className="pt-6 sm:pt-8 pb-6 sm:pb-8">
                ...
                <p className="text-xs sm:text-sm text-muted-foreground mt-2">
                  This is the foundation of financial inclusion powered by Sui's speed and efficiency.
                </p>
              </CardContent>
            </Card>
          </motion.div>
